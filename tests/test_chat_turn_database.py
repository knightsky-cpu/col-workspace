...
def test_memory_engine_no_longer_exposes_chat_owned_artifact_writers() -> None:
    assert not hasattr(MemoryEngine, "record_chat_turn_blueprint_effect")
    assert not hasattr(
        MemoryEngine,
        "record_chat_turn_single_file_artifact_effect",
    )
    assert not hasattr(MemoryEngine, "record_chat_turn_artifact_feedback_effect")
