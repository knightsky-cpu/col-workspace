...
Documents in this directory are historical snapshots retained for provenance.
They are not current implementation contracts and must not be used to describe
the repository's present behavior, data model, security posture, or delivery
status.
